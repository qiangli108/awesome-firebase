...
- 🔧 [Firestudio](https://github.com/FlowdeskApp/firestudio) - Бесплатное настольное приложение с открытым исходным кодом для управления Firebase - Firestore, Storage и Authentication с мощным графическим интерфейсом.
